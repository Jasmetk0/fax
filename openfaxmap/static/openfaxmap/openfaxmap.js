(function () {
  ...
  function onEachFeature(feature, layer) {
    ...
    if (name) {
      layer.bindTooltip(name, { permanent: false, direction: "center", className: "ofm-label" });
    }
  }

  function loadGeoJSON(data) {
    if (geoLayer) geoLayer.remove();
    geoLayer = L.geoJSON(data, { style: featureStyle, onEachFeature });
    geoLayer.addTo(map);
    fitToData();
